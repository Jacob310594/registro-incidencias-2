...
// Cambia la URL automáticamente si estás en local o en producción (GitHub Pages)
const API_BASE = window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1"
  ? "http://localhost:5000/api"
  : "https://tu-backend-desplegado.com/api"; // Aquí pondrás la URL de Render, Railway, etc.
